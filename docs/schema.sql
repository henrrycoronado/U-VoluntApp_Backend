...
CREATE TABLE public.vol_program_contents (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    uva_code VARCHAR(50) NOT NULL UNIQUE,
...
CREATE INDEX idx_vol_program_contents_uva_code ON public.vol_program_contents(uva_code);

CREATE TABLE public.vol_program_collaborators (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    uva_code VARCHAR(50) NOT NULL UNIQUE,
...
CREATE INDEX idx_vol_program_collaborators_uva_code ON public.vol_program_collaborators(uva_code);

CREATE TABLE public.vol_program_patterns (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    uva_code VARCHAR(50) NOT NULL UNIQUE,
    program_code VARCHAR(50) REFERENCES public.vol_programs(uva_code) NOT NULL,
    name TEXT NOT NULL,
...
CREATE INDEX idx_vol_program_patterns_uva_code ON public.vol_program_patterns(uva_code);

CREATE TABLE public.vol_program_pattern_details (
    id BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    uva_code VARCHAR(50) NOT NULL UNIQUE,
    vol_program_pattern_code VARCHAR(50) REFERENCES public.vol_program_patterns(uva_code) NOT NULL,
...
CREATE INDEX idx_vol_program_pattern_details_uva_code ON public.vol_program_pattern_details(uva_code);
...
CREATE TABLE public.activities (
    ...
    vol_program_pattern_code VARCHAR(50) REFERENCES public.vol_program_patterns(uva_code),
    name TEXT NOT NULL,
    description TEXT,
